<?php
	...
	$pages = array(
		...
		'1'	=> array('id' => '4', 'alias' => 'ПРОДУКЦИЯ', 'file' => '4.php'),
		'2'	=> array('id' => '9', 'alias' => 'Железо-бетонные-изделия', 'file' => '9.php'),
		'3'	=> array('id' => '5', 'alias' => 'Штукатурки', 'file' => '5.php'),
		'4'	=> array('id' => '6', 'alias' => 'Шпаклевки', 'file' => '6.php'),
		'5'	=> array('id' => '7', 'alias' => 'Монтажные-смеси', 'file' => '7.php'),
		'6'	=> array('id' => '15', 'alias' => 'Плиточный-клей', 'file' => '15.php'),
		'7'	=> array('id' => '8', 'alias' => 'ПГП', 'file' => '8.php'),
		'8'	=> array('id' => '13', 'alias' => 'ЦПС', 'file' => '13.php'),
		'9'	=> array('id' => '2', 'alias' => 'О-нас', 'file' => '2.php'),
		'10'	=> array('id' => '3', 'alias' => 'Контакты', 'file' => '3.php'),
		'11'	=> array('id' => '10', 'alias' => 'Сертификаты', 'file' => '10.php'),
		'12'	=> array('id' => '11', 'alias' => 'Услуги', 'file' => '11.php'),
		'13'	=> array('id' => '12', 'alias' => 'Карта-партнера', 'file' => '12.php'),
		'14'	=> array('id' => '14', 'alias' => 'Прис', 'file' => '14.php')
	);
	$forms = array(
		'3'	=> array(
			'69f86660' => Array( 'email' => 'monolitplus34@mail.ru', 'emailFrom' => '', 'subject' => 'Сообщение от monolitplus.ru', 'sentMessage' => 'Сообщение отправлено. Спасибо!', 'object' => '', 'objectRenderer' => '', 'loggingHandler' => '', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Имя', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'Эл. почта', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Сообщение', 'type' => 'textarea', 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	...
	$base_url = '/';
	$user_domain = 'monolitplus34.ru';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang, $urlArgs, $route) = parse_uri();
	$user_key = "p/VdAzCq3auJddkcDN/4Dg==";
	$user_hash = "5ae85d2c51ed838b";
